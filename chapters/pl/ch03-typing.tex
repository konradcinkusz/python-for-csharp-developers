...
czwórki cokolwiek kosztuje przy tworzeniu.
...
Te dwa nie są wymienne i poprzednia sekcja mówi dlaczego. \api{pyright} jest
szybki, prawdopodobnie już działa w twoim edytorze, a jego tryb strict jest
naprawdę wysoko postawioną poprzeczką. \api{mypy} jest wolniejszy, jest
starszym i szerzej wdrożonym z tej dwójki, a jego profil strict niesie garść
opinii, których \api{pyright} nie ma, i z których \code{no-any-return} jest
tą zmierzoną w tym rozdziale.
