...
\pkg{difflib}, a długie wyjście przestanie być przycinane.
\api{running\_on\_ci} w \pkg{\_pytest.compat} jest prawdziwe, gdy
\code{CI} albo \code{BUILD\_NUMBER} jest ustawione i niepuste, a raportowanie
czyta je w więcej niż jednym miejscu \dash{} porównanie sekwencji,
przycinanie długiego wyjścia i skracanie linii podsumowania. To świadoma
...
\pyregion{code/src/trace_assert/assertions.py}{presence}{Pierwsze dwie asercje i komunikaty, którymi się nie udają}{lst:ch11-assertions}
