...
\pyregion{code/src/trace_assert/assertions.py}{attempts}{Cztery linie, z których pierwsze trzy to ta dyscyplina}{lst:ch14-attempts}
...
Framework & xUnit, jeden test na scenariusz & własny runner & \pkg{pytest}, jeden test na tezę \\
...
dopuszcza powtarzające się pola, a słownik zachowa tylko ostatnie
\code{Requires-Dist} z dwunastu. Uruchomiony na projekcie tej książki
raportuje:
...
Pythona, na której książka jest budowana, i deklarującą dwanaście
...
\code{trace-assert}. Test ją parsuje i pyta o sześć rzeczy; przeczytaj
test, bo to on jest specyfikacją. Dwie z tych sześciu to te, które ta
