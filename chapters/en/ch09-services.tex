...
\begin{exercise}{e09_01_problem_details}{Give the service the error shape your callers expect}
...
\begin{exercise}{e09_02_response_model}{The wire name and the field name are different things}
...
\begin{exercise}{e09_03_settings}{Configuration that fails at startup, not at first use}
...
\begin{exercise}{e09_04_async_client}{Exercise the application without starting a server}
...
\begin{exercise}{e09_05_scoped_dependency}{A dependency with a lifetime}
