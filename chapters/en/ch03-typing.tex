...
the value, and it is the only one of the four that does anything at
construction beyond assigning the fields.
...
is what your editor is probably already running, and its strict mode is a
genuinely high bar. \api{mypy} is the older of the two by more than a decade,
and its strict profile carries a handful of opinions \api{pyright} does not
have, of which \code{no-any-return} is the one this chapter measured. Which
of them is quicker over your tree is a thing this book has not measured, so
do not take a speed claim from anybody who has not either.
