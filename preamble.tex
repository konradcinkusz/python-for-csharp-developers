...
\newcommand{\pyfile}[3]{%
  \lstinputlisting[language=pythonx,style=bookcode,caption={#2},label={#3}]{#1}%
}
...
\newcommand{\pyregion}[4]{%
  \lstinputlisting[
    language=pythonx, style=bookcode,
...
\newcommand{\csfile}[3]{%
  \lstinputlisting[language=csharpx,style=bookcode,caption={#2},label={#3}]{#1}%
}
...
\newcommand{\exercise}[3]{%
  ...
  \lblExerciseRun: \texttt{uv run pytest -k \detokenize{#1}}\par}
  \end{exercisebox}%
}
