...
% The C# twin of \pyregion, for the comparison half of a pair when only
% part of the file is wanted. Appendix D prints twenty of these beside
% twenty \pyregion s, which is what "solved in both languages" means.
\newcommand{\csregion}[4]{%
  \listingpath{#1}%
