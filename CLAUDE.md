...
| Chapters | **3 of 14 written: Chapter 3, *Typing*, Chapter 7, *Imports and dependency injection*, and Chapter 12, *Observability and operations* — both editions** | 1, 2, 4–6, 8–11, 13, 14 |
| Appendices | **E (Manifest), generated.** A–D are briefs | A, B, C, D |
| Code | `code/` is a locked uv project: the `trace-assert` skeleton, Chapters 3, 7 and 12's listings and exercises, Chapter 12's three Dockerfiles, the measurement scripts, and CI runs all of it | every other chapter's listings and exercises; seven of the eight experiments |
...
and 12 were written in parallel, by separate passes, each against the issue
...
- 54 listing references, every file and region present · 13 exercises, each
...
- Parity: 23 file pairs, 0 failures, 0 warnings · 83 labels in each edition,
  0 mismatches
...
Three chapters of fourteen are written, 3, 7 and 12. The outstanding work is
