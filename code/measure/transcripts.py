...
TRANSCRIPTS: dict[str, Listing | Command] = {
    ...
    "ch04-dunders": Listing("ch04/dunders.py"),
    "ch04-equality": Listing("ch04/equality.py"),
    "ch04-money": Listing("ch04/money.py"),
    "ch04-enums": Listing("ch04/enums.py"),
    "ch04-state": Listing("ch04/state.py"),
    "ch04-arithmetic": Listing("ch04/arithmetic.py"),
    "ch05-decorators": Listing("ch05/decorators.py"),
    "ch05-parameters": Listing("ch05/parameters.py"),
    "ch05-late-binding": Listing("ch05/late_binding.py"),
    "ch05-pipeline": Listing("ch05/pipeline.py"),
    "ch05-generators": Listing("ch05/generators.py"),
    "ch05-matching": Listing("ch05/matching.py"),
    ...
    "ch09-depends": Listing("ch09/depends_scope.py"),
    "ch09-middleware": Listing("ch09/middleware_order.py"),
    "ch09-serialisation": Listing("ch09/serialisation.py"),
    "ch09-validation": Listing("ch09/validation.py"),
