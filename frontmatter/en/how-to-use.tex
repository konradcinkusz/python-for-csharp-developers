...
\noindent
Run it from \code{code/}, the directory its own docstring names, and it
prints this, which is also generated rather than typed \dash{} the line below
is what the pinned interpreter printed when the book was last built:
...
\begin{exercise}{e00_01_hello}{Make the first test pass}
