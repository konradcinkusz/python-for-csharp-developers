...
\noindent
Uruchomiony z katalogu \code{code/}, tego, który wskazuje jego własny
docstring, drukuje to, co poniżej \dash{} również wygenerowane, a nie
przepisane: ta linia jest tym, co przypięty interpreter wydrukował przy
ostatnim buildzie książki:
...
\begin{exercise}{e00_01_hello}{Spraw, żeby pierwszy test przeszedł}
